...
const FavoritesOfferScreen = (props) => {
  const {offers, history, getActiveOfferIdAction, email, offersFavorites, postOfferFavoriteStatusAction, active, fetchOffersFavoritesListAction} = props;
